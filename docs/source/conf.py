...
# my_dummy_example documentation build
...
from my_dummy_example import __version__ as release

# -- Project information -----------------------------------------------------

project = "my_dummy_example"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "my_dummy_exampledoc"
...
latex_documents = [
    (
        master_doc,
        "my_dummy_example.tex",
        "my_dummy_example Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "my_dummy_example",
        "Project my_dummy_example codebase.",
        "Data-Science",
    )
]
